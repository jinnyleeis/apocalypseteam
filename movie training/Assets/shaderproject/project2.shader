...
#pragma domain domain
    ...
    Varyings vert(Attributes input)
    {
        ...
        float NoiseSmaller = tex2Dlod(_Noise, float4(input.uv*2, 0, 0)).r;//uv가 doubled되었으므로!
 ...
 //
  ...
  //  }
    ...
    half4 frag(Varyings IN) : SV_Target
    {
        ...
        float NoiseSmaller = tex2Dlod(_Noise, float4(IN.uv*2, 0, 0)).r;//uv가 doubled되었으므로!
        float combineNoise = (Noise*NoiseSmaller)*0.5;
        return combineNoise* _TintColor;
    }
        ENDHLSL
    }
    }
